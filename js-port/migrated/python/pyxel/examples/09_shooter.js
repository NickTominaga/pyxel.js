...
function loadBgm(msc, filename, snd1, snd2, snd3) {
    ...
    // TODO(python): with open(filename, "rt") as file:
...
class Background {
    constructor() {
        ...
        for (const i of range(NUM_STARS)) {
            this.stars.append(;
                // TODO(python): (
                    // TODO(python): pyxel.rndi(0, pyxel.width - 1),
                    // TODO(python): pyxel.rndi(0, pyxel.height - 1),
                    // TODO(python): pyxel.rndf(1, 2.5),
                // TODO(python): )
            // TODO(python): )
...
class Player {
    ...
    update() {
        ...
        if (pyxel.btn(pyxel.KEY_DOWN) || pyxel.btn(pyxel.GAMEPAD1_BUTTON_DPAD_DOWN)) {
            this.y += PLAYER_SPEED;
...
class App {
    ...
    initImage() {
        ...
        pyxel.images[0].set(;
            ...
            // TODO(python): 0,
            // TODO(python): [
                // TODO(python): "00c00c00",
                // TODO(python): "0c7007c0",
                // TODO(python): "0c7007c0",
                // TODO(python): "c703b07c",
                // TODO(python): "77033077",
                // TODO(python): "785cc587",
                // TODO(python): "85c77c58",
                // TODO(python): "0c0880c0",
            // TODO(python): ],
        // TODO(python): )
        ...
        pyxel.images[0].set(;
            ...
            // TODO(python): 0,
            // TODO(python): [
                // TODO(python): "00088000",
                // TODO(python): "00ee1200",
                // TODO(python): "08e2b180",
                // TODO(python): "02882820",
                // TODO(python): "00222200",
                // TODO(python): "00012280",
                // TODO(python): "08208008",
                // TODO(python): "80008000",
            // TODO(python): ],
        // TODO(python): )
    ...
    updateTitleScene() {
        if (pyxel.btnp(pyxel.KEY_RETURN) || pyxel.btnp(pyxel.GAMEPAD1_BUTTON_START)) {
    ...
    updatePlayScene() {
        ...
        for (const enemy of enemies) {
            ...
            // TODO(python): ):
                ...
                blasts.append(;
                    Blast(;
                        // TODO(python): self.player.x + PLAYER_WIDTH / 2,
                        // TODO(python): self.player.y + PLAYER_HEIGHT / 2,
                    // TODO(python): )
                // TODO(python): )
                pyxel.stop();
                pyxel.play(3, 1);
    ...
    draw() {
        ...
        // TODO(python): pyxel.text(39, 4, f"SCORE {self.score:5}", 7)
