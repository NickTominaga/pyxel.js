...
class Enemy1 {
    ...
    update() {
        ...
        if (this.direction < 0 and is_wall(this.x - 1, this.y + 4)) {
            this.direction = 1;
        }
        else if (this.direction > 0 and is_wall(this.x + 8, this.y + 4)) {
            this.direction = -1;
...
class Enemy2 {
    ...
    update() {
        ...
        if (is_wall(this.x, this.y + 8) or is_wall(this.x + 7, this.y + 8)) {
            if this.direction < 0 and (;
                is_wall(this.x - 1, this.y + 4) or not is_wall(this.x - 1, this.y + 8);
            ):;
                this.direction = 1;
            elif this.direction > 0 and (;
                is_wall(this.x + 8, this.y + 4) or not is_wall(this.x + 7, this.y + 8);
            ):;
                this.direction = -1;
